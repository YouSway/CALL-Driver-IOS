//
//  newNewsSvcViewController.m
//  DriverClient
//
//  Created by 黃柏鈞 on 2016/8/11.
//  Copyright © 2016年 YouSway. All rights reserved.
//

#import "newNewsSvcViewController.h"
#import "style.h"
@interface newNewsSvcViewController ()

@end

@implementation newNewsSvcViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title=@"最新通知";
    ...
    NSString *urlNameInString = @"https://www.msn.com";
