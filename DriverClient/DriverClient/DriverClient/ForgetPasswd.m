...
-(void)Forget{
    ...
    UILabel *nonsense = [[UILabel alloc] initWithFrame:CGRectMake(width/2-160, 20, 320,40)];
    ...
    nonsense.textColor = [UIColor grayColor];
    [self.view addSubview:nonsense];
    
    
    
    UILabel *inf = [[UILabel alloc] initWithFrame:CGRectMake(width/2-160, nonsense.frame.origin.y+nonsense.frame.size.height+10 , 320, 150)];
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(width/2-140,infphone.frame.origin.y+60,280,1.5)];
    ...
    [idField addTarget:self action:@selector(textFieldDone:) forControlEvents:UIControlEventEditingDidEndOnExit];
