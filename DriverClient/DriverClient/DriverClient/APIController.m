...
//http://udriver2.templar-develop.com/api
#define PublicIP ("http://udriver2.templar-develop.com/api/driver") //ServerIP
...
+(NSDictionary *)Login:(NSDictionary *)data{
    ...
    if ([NSJSONSerialization isValidJSONObject:dict]) {
        ...
        if (json != nil && error == nil) {
            NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%s/login",PublicIP]];
...
+(NSDictionary *)Select_driver_role:(NSDictionary *)data{
    ...
    if ([NSJSONSerialization isValidJSONObject:dict]) {
        json = [NSJSONSerialization dataWithJSONObject:dict options:NSJSONWritingPrettyPrinted error:&error];
        if (json != nil && error == nil) {
            NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%s/chooseDriverType",PublicIP]];
            NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:url];
            [request setHTTPMethod:@"POST"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Accept"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
...
+(NSDictionary *)CredentialsCheck:(NSDictionary *)data{
    ...
    if ([NSJSONSerialization isValidJSONObject:dict]) {
        json = [NSJSONSerialization dataWithJSONObject:dict options:NSJSONWritingPrettyPrinted error:&error];
        if (json != nil && error == nil) {
            NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%s/credentialsCheck",PublicIP]];
            NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:url];
            [request setHTTPMethod:@"POST"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Accept"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
...
+(NSDictionary *)InsertDriverInfo:(NSDictionary *)data{
    ...
    if ([NSJSONSerialization isValidJSONObject:dict]) {
        json = [NSJSONSerialization dataWithJSONObject:dict options:NSJSONWritingPrettyPrinted error:&error];
        if (json != nil && error == nil) {
            NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%s/insertDriverInfo",PublicIP]];
            NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:url];
            [request setHTTPMethod:@"POST"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Accept"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
...
+(NSDictionary *)Upload_credentials:(NSDictionary *)data{
    ...
    if ([NSJSONSerialization isValidJSONObject:dict]) {
        json = [NSJSONSerialization dataWithJSONObject:dict options:NSJSONWritingPrettyPrinted error:&error];
        if (json != nil && error == nil) {
            NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%s/insertDriverCredentialsPhoto",PublicIP]];
            NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:url];
            [request setHTTPMethod:@"POST"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Accept"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
...
+(NSDictionary *)AccountCheck:(NSDictionary *)data{
    ...
    if ([NSJSONSerialization isValidJSONObject:dict]) {
        json = [NSJSONSerialization dataWithJSONObject:dict options:NSJSONWritingPrettyPrinted error:&error];
        if (json != nil && error == nil) {
            NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%s/accountCheck",PublicIP]];
            NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:url];
            [request setHTTPMethod:@"POST"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Accept"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
...
+(NSDictionary *)PasswordChange:(NSDictionary *)data{
    ...
    if ([NSJSONSerialization isValidJSONObject:dict]) {
        json = [NSJSONSerialization dataWithJSONObject:dict options:NSJSONWritingPrettyPrinted error:&error];
        if (json != nil && error == nil) {
            NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%s/passwordChange",PublicIP]];
            NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:url];
            [request setHTTPMethod:@"POST"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Accept"];
            [request setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
