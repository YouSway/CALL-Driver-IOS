...
//        slideMenu.navTitleLabel.text=[[array objectAtIndex:indexPath.row+1] objectForKey:@"funName"];
    ...
    switch (indexPath.row) {
        ...
        case 1:
            if (!_screenCP) {
                _screenCP = [[screenConditionPage alloc]init];
            }
            selectPage = _screenCP;
            
            break;
            
        case 2:
            if (!_waitFRVC) {
                _waitFRVC = [[waitForRunViewController alloc]init];
            }
            selectPage = _waitFRVC;
            break;
            
        case 3:
            if (!_pastBVC) {
                _pastBVC=[[pastBillViewController alloc]init];
            }
            selectPage=_pastBVC;
            break;
        ...
        case 9:
            ...
            break;
        case 10:
            selectPage=[[Integral alloc]init];
            break;
            
        case 11:
            {
                NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
                [userDefaults removeObjectForKey:@"userReg"];
                ...
                selectPage=[[ViewController alloc]init];
                break;
            }
